  ...
  <div class="auth-page">
    <div class="auth-container">
      ...
      <div class="auth-branding">
        ...
        <h1 class="brand-title">Join Tattant</h1>
        <p class="brand-subtitle">Create your account and start exploring Japan like never before</p>
        <div class="brand-features">
          <div class="brand-feature">
            <span class="feature-icon">✓</span>
            <span>Access curated travel guides</span>
          </div>
          <div class="brand-feature">
            <span class="feature-icon">✓</span>
      ...
      <div class="auth-form-container">
        <div class="auth-card">
          ...
          <form @submit.prevent="handleRegister" class="auth-form">
            ...
            <div class="form-group">
              <label for="birthdate" class="form-label">Birthdate <span class="optional">(optional)</span></label>
              <input
                id="birthdate"
